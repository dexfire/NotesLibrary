...
var builder = new ReopenUrlBuilder("https:\/\/www.adnetworkperformance.com\/script\/java.php?option=rotateur&r=411313&treqn=843124154&runauction=1&crr=8aef1cc2ca74a6434045OpTL61GbpdGZm93ZsVyY4lmT60SZntmJhJ3Z-1mJ7hHep5kOt4kOtk0OtsHe8xHY0235cc5cfe0864d5115c&rtid=5b1c8b351f19b");
var url = builder.build();

    var content = '<iframe width="468" height="60" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5b1c8b351f19b"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5b1c8b351f19b').removeAttribute('sandbox');
    }
