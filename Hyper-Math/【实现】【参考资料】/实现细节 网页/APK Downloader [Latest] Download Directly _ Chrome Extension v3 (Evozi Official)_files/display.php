...
var builder = new ReopenUrlBuilder("https:\/\/www.adnetworkperformance.com\/ad\/display.php?r=200834&treqn=1280627614&runauction=1&crr=3155b3ecf34611bcdbd1VEmdhYzNywzP9QCP34HOjITFhZnP8ATf6kCPlYTfgMyIyURY2VRY2JBY2ByIncyO58785539e53a07d68e60&rtid=5b1c8b342c10f");
var url = builder.build();

    var content = '<iframe width="468" height="60" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5b1c8b342c10f"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5b1c8b342c10f').removeAttribute('sandbox');
    }
